...
import net.benfro.library.bookhub.BookHubApplication;
...
//import se.agila.assignment.Application;

import java.util.Map;

@SpringBootTest(classes = {BookHubApplication.class, IntegrationTest.TestConfig.class},
